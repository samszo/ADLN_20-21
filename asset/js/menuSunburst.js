    ...
    constructor(params) {
        ...
        this.init = function () {
            ...
            svgMenu = me.cont.append("svg")
                    ...
                    .attr("width",me.width+'px').attr("height", me.width+'px')
           ...
           path.style("cursor", "pointer")
            ...
            let bb = svgMenu.node().getBBox();
            svgMenu.attr('viewBox',(bb.x)+' '+(bb.y)+' '+' '+(bb.width)+' '+(bb.height));
        ...
        function fctExecute(p) {
            switch (p.data.fct) {
                case 'afficheEtatInitial':
                  afficheEtatInitial(p)
                  break;
                case 'afficheEvents':
                  afficheEvents(p)
                  break;
